...
class ConversionThread(QThread):
    ...
    def clean_subtitle_text(self, text):
        """
        Garantili İtalik Koruma ve Temizlik Sistemi.
        """
        # 1. Tüm İtalik varyasyonlarını maskele (Zırh altına al)
        ...
        # 5. Maskelenmiş italikleri standart SRT etiketine geri çevir
